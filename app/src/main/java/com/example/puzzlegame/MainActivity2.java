...
public class MainActivity2 extends AppCompatActivity {
    ...
    private static void display(Context context) {
        ...
        for(int i = 0; i < tileList.length; i++){
            ...
            if(tileList[i].equals("0")){
                button.setBackgroundResource(R.drawable.im1);
            }else if (tileList[i].equals("1"))
                button.setBackgroundResource(R.drawable.im2);
            else if (tileList[i].equals("2"))
                button.setBackgroundResource(R.drawable.im3);
            else if (tileList[i].equals("3"))
                button.setBackgroundResource(R.drawable.im4);
            else if (tileList[i].equals("4"))
                button.setBackgroundResource(R.drawable.im5);
            else if (tileList[i].equals("5"))
                button.setBackgroundResource(R.drawable.im6);
            else if (tileList[i].equals("6"))
                button.setBackgroundResource(R.drawable.im7);
            else if (tileList[i].equals("7"))
                button.setBackgroundResource(R.drawable.im8);
            else if (tileList[i].equals("8"))
                button.setBackgroundResource(R.drawable.im9);
    ...
    private void init(){
        mGridView = (GestureDetectGridView2) findViewById(R.id.grid2);
